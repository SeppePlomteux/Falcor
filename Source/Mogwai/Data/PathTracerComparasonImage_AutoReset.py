...
def render_graph_PathTracerGraph():
    ...
    ResetPipelinePass = createPass('ResetPipelinePass')
    g.addPass(ResetPipelinePass, 'ResetPipelinePass')
    ...
    g.addEdge('MegakernelPathTracer.color', 'ResetPipelinePass.color')
    g.addEdge('ResetPipelinePass.color', 'AccumulatePass.input')
